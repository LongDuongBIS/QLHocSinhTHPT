namespace QuanLyTruongCap3.Reports
{
    partial class frptDanhSachHocSinh
    {
        ...
        private void InitializeComponent()
        {
            ...
            // bSDSHocSinh
            // 
            this.bSDSHocSinh.DataSource = typeof(QuanLyTruongCap3.DTO.HocSinhDTO);
            // 
            // reportViewerDSHS
            // 
            this.reportViewerDSHS.Dock = System.Windows.Forms.DockStyle.Fill;
            reportDataSource1.Name = "QuanLyTruongCap3_Bussiness_HocSinhInfo";
            reportDataSource1.Value = this.bSDSHocSinh;
            this.reportViewerDSHS.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewerDSHS.LocalReport.ReportEmbeddedResource = "QuanLyTruongCap3.Reports.rptDanhSachHocSinh.rdlc";
